...
前回の[第5回](https://qiita.com/naoki_hayashida/items/55abc096c40f1ae6a19f)では、離散対数問題に基づく暗号技術について学びました。RSA暗号や楕円曲線暗号といった従来の公開鍵暗号は、データの暗号化と復号、署名の生成と検証という基本的な機能を提供します。
